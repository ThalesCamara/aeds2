...
// Importações necessárias para datas (usadas em normalizeDate)
...
        // =======================================================
        // CORREÇÃO: Imprime a lista ordenada completa (Saída Principal)
        // =======================================================
        for (int i = 0; i < pesquisa.length; i++) {
            System.out.println(pesquisa[i].toString());
        }
        System.out.println(); // Adiciona uma linha em branco para separar os blocos
        // =======================================================
...
  L     mergeSortRecursive(a, aux, mid + 1, right);
        
...
section         if (s.equalsIgnoreCase("Free to Play")) return 0.0f;
...
s           return String.format("%02d/%02d/%04d", day, month, year);
        }
...
section             g.estimatedOwners + " ## " +                             // Número estimado de donos
            g.price + " ## " +                                       // Preço
section             auxiliarMostrar(g.supportedLanguages, g.supportedLanguagesCount) + " ## " +         // Idiomas suportados
            g.metacriticScore + " ## " +                             // Nota Metacritic
section             g.userScore + " ## " +                                   // Nota dos usuários
            g.achievements + " ## " +                                // Número de conquistas
section             auxiliarMostrar(g.publishers, g.publishersCount) + " ## " +                 // Publicadores
...
Ass             auxiliarMostrar(g.tags, g.tagsCount) + " ##";                         // Tags
    }
